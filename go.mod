module gitlab.flyele.vip/server-side/go-zero/v2

go 1.17

require (
	github.com/963204765/httpclient v0.0.0-20201210072243-522af3cdfe83
	...
	github.com/sensorsdata/sa-sdk-go v2.0.5+incompatible
