...
import (
	...
	"gitlab.flyele.vip/server-side/go-zero/v2/core/discov"
	...
	coresqlx "gitlab.flyele.vip/server-side/go-zero/v2/core/stores/sqlx"
	_ "gitlab.flyele.vip/server-side/go-zero/v2/core/sysx"
